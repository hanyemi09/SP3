 ...
 */
CStructure2_3D::CStructure2_3D(void)
	: cGroundMap(NULL)
{
 ...
 */
CStructure2_3D::CStructure2_3D(	const glm::vec3 vec3Position,
...
bool CStructure2_3D::Init(void)
{
	...
	std::string file_path = "OBJ/pillar.obj";
 ...
 */
void CStructure2_3D::SetModel(glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CStructure2_3D::SetView(glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CStructure2_3D::SetProjection(glm::mat4 projection)
{
...
*/
void CStructure2_3D::Update(const double dElapsedTime)
{
...
*/
void CStructure2_3D::ActivateCollider(Shader* cLineShader)
{
...
*/
void CStructure2_3D::PreRender(void)
{
	// Draw this as last
...
*/
void CStructure2_3D::Render(void)
{
...
*/
void CStructure2_3D::PostRender(void)
{
